...
def getReleves(scope):
    ...
    user_cruved = get_scopes_by_action(module_code=g.current_module.module_code)
...
def getOneReleve(id_releve, scope):
    ...
    user_cruved = get_or_fetch_user_cruved(
        session=session, id_role=g.current_user.id_role, module_code=g.current_module.module_code
    )
    ...
    releve_cruved = {
        ...
        "cruved": releve.get_releve_cruved(g.current_user, user_cruved),
    }
...
def releveHandler(request, *, releve):
...
def occurrenceHandler(request, *, occurrence):
